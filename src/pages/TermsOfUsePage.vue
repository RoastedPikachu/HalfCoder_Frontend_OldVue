<template>
  <section id="TermsOfUse">
    ...
    <p><strong>Предмет соглашения</strong><br>
    ...
    <p><strong>Условия действия Соглашения</strong><br>
    ...
    <p><strong>Соглашение разработано на базе юридических документов сервиса Правилль</strong></p>
  </section>
</template>
